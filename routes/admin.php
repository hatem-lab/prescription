...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () use ($namespacePrefix) {
...
Route::get('register','VoyagerAuthController@register')->name('admin.register');
Route::post('register','VoyagerAuthController@postRegister');
