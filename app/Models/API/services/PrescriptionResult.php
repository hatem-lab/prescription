 ...
 *
 * @OA\Schema(
 *     title="PrescriptionResult model",
 *     description="PrescriptionResult model",
 * )
 */
class PrescriptionResult extends Model
{
    protected $fillable = [
    ...
    /**
     * @OA\Property(
     *     description="PrescriptionApiModel Result Model",
     *     title="result",
     *     @OA\Items(ref="#/components/schemas/PrescriptionApiModel")
     * )
     *
     * @var array
     */
