...
/**
 * Class UpdatePrescriptionPayLoad
 *
 * @package Petstore30
 *
 * @OA\Schema(
 *     title="UpdatePrescriptionPayLoad model",
 *     description="UpdatePrescriptionPayLoad model",
 * )
 */
class UpdatePrescriptionPayLoad extends Model
{

    protected $fillable = [
        'prescription_id','costomer_id', 'doctor_id', 'date_prescription','date_prescription_renewal','date_prescription_send_to_doctor',
