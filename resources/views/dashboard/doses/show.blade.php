...
@section('title')
    {{Lang::get('all.Show Dose',[],getCurrentLang())}}
@stop
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{Lang::get('all.Show Dose',[],getCurrentLang())}}
                                </li>

                            </ol>
                            <br>
                            <br>
                            <a href="{{route('admin.doses.edit',$dose->id)}}" class=" btn btn-outline-primary " data-effect="effect-scale"
                            > {{Lang::get('all.Edit Dose',[],getCurrentLang())}}</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i>  <b> {{Lang::get('all.Doses Description',[],getCurrentLang())}}</b> </h4>
                                            <div class="card-content collapse show">
                                            ...
                                            <div class="card-content collapse show">
                                                <div class="card-body card-dashboard">
                                                    ...
                                                    <td>{{$dose->created_at->diffForHumans()}}</td>
                                                    </thead>
                                                </div>
                                            </div>
                                            <hr>
