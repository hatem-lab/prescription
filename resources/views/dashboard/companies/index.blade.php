        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{Lang::get('all.all companies',[],getCurrentLang())}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{Lang::get('all.dashboard',[],getCurrentLang())}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{Lang::get('all.all companies',[],getCurrentLang())}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a  href="{{route('admin.companies.create')}}" class=" btn btn-outline-primary " data-effect="effect-scale"
                                    >  {{Lang::get('all.Add Company',[],getCurrentLang())}}</a>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{Lang::get('all.company_name',[],getCurrentLang())}} </th>
