                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{Lang::get('all.update Users',[],getCurrentLang())}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{Lang::get('all.update User',[],getCurrentLang())}}  </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <option value="" selected>{{$user->user_type}}</option>
                                                                <optgroup label="{{Lang::get('all.select user type',[],getCurrentLang())}} ">
