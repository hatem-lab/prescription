                  ...
                  <span
                      class="user-name text-bold-700">  {{auth('admin') -> user() -> username}}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}"><i
                                    class="ft-user"></i> {{Lang::get('all.Edit Profile',[],getCurrentLang())}} </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}"><i class="ft-power"></i> {{Lang::get('all.logout',[],getCurrentLang())}}</a>
                        </div>
                    </li>
