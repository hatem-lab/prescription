...
@section('title')
    {{Lang::get('all.Edit Category',[],getCurrentLang())}}
@stop
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{Lang::get('all.update',[],getCurrentLang())}} - {{$category -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{Lang::get('all.update categories',[],getCurrentLang())}} </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>  {{Lang::get('all.categories data',[],getCurrentLang())}} </h4>
                                                <div class="row">
