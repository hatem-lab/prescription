                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$medication->medication_cost}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$medication->commercial_name}}"
                                                                ...
                                                                <optgroup label="من فضلك أختر  الفئة ">
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories  as $category)
                                                                            <option
                                                                                value="{{$category -> id }}"
                                                                                @if($category -> id===$medication->category->id) selected @endif>{{$category -> name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                                                ...
                                                                <optgroup label="من فضلك أختر  شركة الدواء ">
                                                                    @if($companies && $companies -> count() > 0)
                                                                        @foreach($companies  as $company)
                                                                            <option
                                                                                value="{{$company -> id }}"
                                                                                @if($company -> id===$medication->company->id) selected @endif>{{$company -> company_name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                                                    ...
                                                                    @if($contraindications && $contraindications -> count() > 0)
                                                                        @foreach($contraindications  as $contraindication)
                                                                            <option
                                                                                ...
                                                                                @if($contraindication -> id===$medication->contraindication->id) selected @endif>{{$contraindication -> title}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
